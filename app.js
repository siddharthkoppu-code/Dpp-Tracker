...
@@ -43,9 +40,7 @@ const modalError = document.getElementById("modal-error-message");
...
@@ -78,10 +73,7 @@ function navigateToSubjects() {
...
@@ -93,372 +85,163 @@ async function navigateToChapters() {
try {
